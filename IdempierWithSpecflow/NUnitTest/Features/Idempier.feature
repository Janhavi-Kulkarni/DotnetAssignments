...
Given I navigated on Business Partner from Favorites section
...
Given:I navigated on Business Partner by clicking Ok on searche window with search values
When I Cliked on New Record Icon button
And Entered value
|Field|Value|
|Name|TestBP|
And Cliked on Save Icon button
